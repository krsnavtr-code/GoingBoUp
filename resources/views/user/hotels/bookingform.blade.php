    ...
    <form action="{{ url('hotel/checkout') }}" method="POST" class="text-box" style="overflow: auto; ">
        @csrf
        <!--  General -->
        <input class="hidden" name="prebook" value="{{ json_encode($prebook) }}" hidden>
        <input class="hidden" name="hotelname" value="{{$hotels[0]['HotelName']}}" hidden>
              ...
              <div class="room-details">
                  ...
                  @for ($j = 1; $j <= $currentRoomAdults; $j++)
                      <div class="passenger">
                          ...
                          <input class="hidden" type="hidden" name="passenger[{{ $i }}][adult][{{ $j }}][leadpassenger]" value="{{ $j == 1 ? 'true' : 'false' }}">
                      ...
                      @for ($k = 1; $k <= $currentRoomChildren; $k++)
                          <div class="passenger">
                              ...
                              <div class="controls">
                                  ...
                                  <input class="hidden" type="hidden" name="passenger[{{ $i }}][child][{{ $k }}][age]" value="{{ $childAges[$childIndex] }}">
                              </div>
                                @php
                                $childIndex++;
                                @endphp
        ...
        <div class="grid">
            ...
            <button id="off-btn" type="submit" value="Submit" class="col-1-4">Submit</button>
        </div>
    </form>
