        ...
        <form action="{{ url($page['current']) }}" method="post" enctype="multipart/form-data">
            ...
            <section>
                <div class="field">
                    ...
                    <input type="text" name="cat_title" placeholder="Category Title" id="cat_title"
                        value="{{ $cat['cat_title'] }}">
                </div>
                <div class="field">
                    <label for="cat_desc">Category Description <i class="text info">Optional</i></label>
                    <input type="text" name="cat_desc" placeholder="Category Description" id="cat_desc"
                        value="{{ $cat['cat_desc'] }}">
                </div>
                <div class="field">
                    <input type="file" name="cat_image" id="cat_image">
                    <label for="cat_image" @class(['loaded' => $cat['cat_image']])>
                        <div class="display">
