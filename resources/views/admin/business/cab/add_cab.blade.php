...
@section('content')
    <main>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="company_id" value="{{$businessLogin->id}}">
            <input type="hidden" name="business_profile" value="1">
            <section>
                ...
                <div class="field_group">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="company_name" id="company_name" value="{{$businessLogin->company_name}}" required >
                    </div>
                </div>
                <div class="field_group">
                    <div class="field">
                ...
                <div class="field_group">
                    <div class="field">
                        ...
                        <input type="text" name="owner_contact" id="owner_contact"  value="{{$businessLogin->contact_no}}"  required>
                    </div>
                    <div class="field">
                        <label for="owner_email">Owner Email</label>
                        <input type="email" name="owner_email" id="owner_email"  value="{{$businessLogin->email}}" required>
                    </div>
                </div>
                <div class="field">
