...
Route::controller(BusinessLoginController::class)->prefix("business-login")->group(function () {
    ...
    Route::controller(CabController::class)->prefix('cab')->group(function () {
        ...
        Route::post('/edit/{cabId}', 'business_web_edit_cab');
        
        Route::get('/route', 'business_ui_view_cab_route');
        Route::get('/route/add/{cabId}', 'business_ui_add_cab_route');
        Route::post('/route/add/{cabId}', 'business_web_add_cab_route');

        Route::get('toggle/{cabId}', 'business_toggle_cab');
    ...
    // Common routes
    Route::get('/account-info', 'business_ui_account_info');
